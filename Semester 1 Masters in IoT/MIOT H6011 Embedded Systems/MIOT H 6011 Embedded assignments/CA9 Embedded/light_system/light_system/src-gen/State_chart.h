...
typedef enum
{
	...
	State_chart_main_region_Manual_r1_LIGHT_OFF,
	State_chart_main_region_Manual_r1_LIGHT_ON,
	State_chart_main_region_Automatic,
	State_chart_main_region_Automatic_r1_DarkWaiting,
	State_chart_main_region_Automatic_r1_BrightWating,
	State_chart_main_region_Automatic_r1_LIGHT_OFF,
	State_chart_main_region_Automatic_r1_LIGHT_ON
} State_chartStates;
...
typedef struct
{
	sc_boolean state_chart_main_region_Automatic_r1_DarkWaiting_tev0_raised;
	sc_boolean state_chart_main_region_Automatic_r1_BrightWating_tev0_raised;
...
#define SCVI_STATE_CHART_MAIN_REGION_MANUAL_R1_LIGHT_OFF 0
#define SCVI_STATE_CHART_MAIN_REGION_MANUAL_R1_LIGHT_ON 0
#define SCVI_STATE_CHART_MAIN_REGION_AUTOMATIC 0
#define SCVI_STATE_CHART_MAIN_REGION_AUTOMATIC_R1_DARKWAITING 0
#define SCVI_STATE_CHART_MAIN_REGION_AUTOMATIC_R1_BRIGHTWATING 0
#define SCVI_STATE_CHART_MAIN_REGION_AUTOMATIC_R1_LIGHT_OFF 0
#define SCVI_STATE_CHART_MAIN_REGION_AUTOMATIC_R1_LIGHT_ON 0
